...
const roles = ['Junior Software Engineer', 'Machine Learning Engineer', 'Builder & Analyst', 'Sports Enthusiast'];
  ...
  return (
    <section className="hero" id="home">
      ...
      <div className="hero-cta">
        <a href="/Onasis_A_Resume.pdf" download className="btn btn-primary">
          <FaDownload />
          Résumé
        </a>
